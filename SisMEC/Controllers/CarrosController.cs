...
namespace SisMEC.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarroId,CarroMarca,CarroModelo,CarroObs")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarroId,CarroMarca,CarroModelo,CarroObs")] Carro carro)
        {
            if (id != carro.CarroId)
            {
                return NotFound();
